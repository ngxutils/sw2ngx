...
export declare function resolveEnumFn(description: Description | undefined, enumValue: [unknown, ...unknown[]], propType: 'array' | 'boolean' | 'integer' | 'null' | 'number' | 'object' | 'string' | [
