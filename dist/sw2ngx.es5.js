...
var TemplatePrinter = /** @class */ (function () {
    ...
    TemplatePrinter.prototype.printEnum = function (value) {
        ...
        try {
            writeFileSync(resolve(this.out + '/models/enums/' + changeCase_22(value.name) + '.enum.ts'), compiled);
        }
        catch (e) {
    ...
    TemplatePrinter.prototype.printModel = function (model) {
        ...
        writeFile(resolve(this.out + '/models/' + changeCase_22(model.name) + '.model.ts'), compiled, function (err) {
            if (err) {
    ...
    TemplatePrinter.prototype.printService = function (service, name) {
        ...
        if (compiled !== '') {
            ...
            writeFile(resolve(this.out + '/services/' + changeCase_22(name) + '.service.ts'), compiled, function (err) {
                if (err) {
